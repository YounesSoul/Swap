...
interface SessionStatsCarouselProps {
  stats: {
    total: number;
    scheduled: number;
    completed: number;
...
export const SessionStatsCarousel: React.FC<SessionStatsCarouselProps> = ({
  stats,
  onFilterChange,
}) => {
  ...
  return (
    <div ref={containerRef} className="w-full">
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Session Overview</h2>
        <p className="text-gray-600">Track your learning sessions and progress</p>
      </div>
...
export default SessionStatsCarousel;